...
ruleset d : DATA do startstate "Init"                       
  for i : NODE do
    ...
    Chan1[i].Data := d; Chan2[i].Data := d; Chan3[i].Data := d;
    Cache[i].State := I; Cache[i].Data := d; InvSet[i] := false; ShrSet[i] := false;
  end;
...
invariant "test_531"
!(Cache[1].State=I&Cache[1].Data=2&Cache[2].State=I&Cache[2].Data=1&Cache[3].State=I&Cache[3].Data=1&Cache[4].State=S&Cache[4].Data=2&Chan1[1].Cmd=ReqE&Chan1[2].Cmd=Empty&Chan1[3].Cmd=Empty&Chan1[4].Cmd=Empty&Chan2[1].Cmd=Empty&Chan2[1].Data=1&Chan2[2].Cmd=Empty&Chan2[2].Data=2&Chan2[3].Cmd=Empty&Chan2[3].Data=1&Chan2[4].Cmd=Inv&Chan2[4].Data=2&Chan3[1].Cmd=Empty&Chan3[1].Data=2&Chan3[2].Cmd=Empty&Chan3[2].Data=1&Chan3[3].Cmd=Empty&Chan3[3].Data=2&Chan3[4].Cmd=Empty&Chan3[4].Data=2&InvSet[1]=false&InvSet[2]=false&InvSet[3]=false&InvSet[4]=false&ShrSet[1]=false);